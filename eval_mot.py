...
results_path = '/kuacc/users/ashah20/SAVi/mot_results.json'

parser = argparse.ArgumentParser()
parser.add_argument('--results_path', help='Path to output file.', type=str, default=results_path)
...
parser.add_argument('--exclude_bg', help='Exclude background masks from evaluation.', action='store_true', default=True)
...
def evaluate(pred_file, gt_file):
    ...
    with open(pred_file, 'r') as file:
        pred_dict = json.loads(file.read())
